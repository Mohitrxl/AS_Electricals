...
//         {/* Menu */}
//         <ul
//           className={`md:flex gap-6 absolute md:static top-16 left-0 w-full md:w-auto bg-gray-800 md:bg-transparent flex-col md:flex-row transition-all duration-300 ${
//             menuOpen ? "flex" : "hidden"
//           }`}
//         >
//           <li>
//             <Link href="/" className="block px-4 py-2 hover:text-yellow-400">
//               Home
//             </Link>
//           </li>
//           <li>
...
//             {/* Desktop dropdown */}
//             <ul
//               className={`absolute bg-gray-800 rounded-md mt-2 w-52 shadow-lg transition-all duration-300 transform origin-top hidden md:block ${
//                 activeDrop === "services"
...
//             {/* Mobile accordion */}
//             <ul
//               className={`md:hidden overflow-hidden transition-[max-height] duration-300 bg-gray-700 ${
...
//               </li>
//               <li>
//                 <Link href="/faq" className="block px-4 py-2 hover:bg-gray-700">
//                   FAQ
//                 </Link>
//               </li>
//             </ul>
...
//               </li>
//               <li>
//                 <Link href="/faq" className="block px-6 py-2 hover:bg-gray-600">
//                   FAQ
//                 </Link>
//               </li>
//             </ul>
